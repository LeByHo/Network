...
public class Category extends JFrame {
   ...
   public void placeLoginPanel(JPanel panel) {
	...
	ImageIcon Icon6 = new ImageIcon(changedImg6);
      ...
      Level s1= new Level(0,0,"레벨 1",1);
      Level s2= new Level(0,80,"레벨2",2);
      Level s3= new Level(0,160,"레벨 3",3);
      ...
      Level s4= new Level(0,0,"레벨 1",1);
      Level s5= new Level(0,80,"레벨2",2);
      Level s6= new Level(0,160,"레벨 3",3);
      ...
      Level s7= new Level(0,0,"레벨 1",1);
      Level s8= new Level(0,80,"레벨2",2);
      Level s9= new Level(0,160,"레벨 3",3);
      ...
      c3.add(f9);
      panel.add(c3);
      Level s10= new Level(0,0,"레벨 1",1);
      Level s11= new Level(0,80,"레벨2",2);
      Level s12= new Level(0,160,"레벨 3",3);
      ...
      Level s13= new Level(0,0,"레벨 1",1);
      Level s14= new Level(0,80,"레벨2",2);
      Level s15= new Level(0,160,"레벨 3",3);
      ...
      Level s16= new Level(0,0,"레벨 1",1);
      Level s17= new Level(0,80,"레벨2",2);
      Level s18= new Level(0,160,"레벨 3",3);
...
class Level extends JButton{
   ...
   Level(int x, int y,String s,int i){
	  setFont(f2);
