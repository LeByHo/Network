...
public class Category extends JFrame {
   ...
   static Test f1= new Test(0,40,"Test",1,0);
   static Test f2= new Test(0,120,"Test",2,0);
   static Test f3= new Test(0,200,"Test",3,0);  
   static Test f4= new Test(0,40,"Test",1,1);
   static Test f5= new Test(0,120,"Test",2,1);
   static Test f6= new Test(0,200,"Test",3,1); 
   static Test f7= new Test(0,40,"Test",1,2);
   static Test f8= new Test(0,120,"Test",2,2);
   static Test f9= new Test(0,200,"Test",3,2);
   static Test f10= new Test(0,40,"Test",1,3);
   static Test f11= new Test(0,120,"Test",2,3);
   static Test f12= new Test(0,200,"Test",3,3);    
   static Test f13= new Test(0,40,"Test",1,4);
   static Test f14= new Test(0,120,"Test",2,4);
   static Test f15= new Test(0,200,"Test",3,4);
   static Test f16= new Test(0,40,"Test",1,5);
   static Test f17= new Test(0,120,"Test",2,5);
   static Test f18= new Test(0,200,"Test",3,5);      
...
class Test extends JButton{
   ...
   int score;
   Font f2 = new Font("궁서", Font.BOLD, 20);
   Test(int x, int y,String s,int i,int j){
      setFont(f2);
      setBorderPainted(false);
      setBounds(x, y, 222, 40);
      setBackground(Color.white);
