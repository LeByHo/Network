...
class wword extends JLabel implements Runnable {
   char[] alphabet = { 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's',
         't', 'u', 'v', 'w', 'x', 'y', 'z' };
   String[] wd = { "typically", "datagram", "boundary", "interconnecting", "interface", "optimistically", "advantage",
         "compare", "iterative", "application" };
   String[] wd1 = { "typically", "datagram", "boundary", "interconnecting", "interface", "optimistically", "advantage",
         "compare", "iterative", "application" };
